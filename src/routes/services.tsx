    ...
    <div className="bg-[#F8FAFC] text-slate-800 font-sans antialiased min-h-screen py-6 sm:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200/90 rounded-2xl p-4 sm:px-6 shadow-xs">
          <div className="flex items-center gap-2 text-xs font-bold text-slate-700">
            <span className="text-[#DC2626] font-black">📍 HUBS:</span>
        ...
        <div className="space-y-2">
          ...
          <p className="text-slate-600 text-sm sm:text-base max-w-3xl font-normal leading-relaxed">
            Select a technology architecture from the left menu to inspect detailed engineering blueprints, hardware specifications, and certified deployment brands.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-white border border-slate-200/90 rounded-3xl p-4 sm:p-5 shadow-xs space-y-3 lg:sticky lg:top-24">
              ...
              {SOLUTIONS_DATA.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-3.5 sm:p-4 rounded-2xl text-xs font-extrabold transition-all duration-200 cursor-pointer text-left ${
                      isSelected
                        ? "bg-[#0B132B] text-white shadow-md border border-[#0B132B]"
                  ...
                  >
                    <div className="flex items-center gap-3.5 min-w-0">
                      ...
                      <span className="truncate tracking-tight text-sm sm:text-base font-bold">
                        {item.title}
                      </span>
                    </div>
          ...
          <div className="lg:col-span-7 bg-white border border-slate-200/90 rounded-3xl overflow-hidden shadow-sm flex flex-col justify-between">
            ...
            <div className="relative h-64 sm:h-72 w-full bg-slate-900 overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 right-6 space-y-1.5 text-white">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-[#DC2626] text-white text-[10px] font-black uppercase tracking-widest shadow-md">
            ...
            <div className="flex items-center border-b border-slate-200/90 px-6 bg-slate-50/50">
              {[
                ...
                return (
                  <button
                    ...
                    className={`py-4 px-4 sm:px-6 text-xs sm:text-sm font-extrabold border-b-2 transition-all cursor-pointer ${
                      isActive
            ...
            <div className="p-6 sm:p-8 space-y-6">
              {activeTab === "blueprint" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="text-[11px] font-black uppercase tracking-widest text-[#DC2626]">
              ...
              <div className="pt-6 border-t border-slate-100 flex items-center justify-between gap-4">
                ...
                <Link
                  to="/contact"
                  className="w-full sm:w-auto px-6 py-4 rounded-2xl bg-[#DC2626] hover:bg-[#B91C1C] active:bg-[#991B1B] text-white text-xs font-extrabold tracking-wide flex items-center justify-center gap-2 transition duration-200 group cursor-pointer shadow-lg shadow-red-900/20"
                >
