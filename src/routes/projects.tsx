      ...
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
        ...
        <div className="space-y-2.5 sm:space-y-3">
          ...
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider">
            ...
            <span className="text-sky-600 font-bold">LANDMARK PROJECTS</span>
          </div>
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`px-3.5 py-2 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer shrink-0 ${
                  isActive
                    ? "bg-[#06143D] text-white shadow-md"
          ...
          {filteredProjects.map((project) => (
            ...
            >
              <div>
                ...
                <div className="relative h-56 sm:h-72 w-full bg-slate-900 overflow-hidden group">
                  <img
                    src={project.image}
                    alt={project.title}
                  ...
                  {/* Top Left Sky Category Badge */}
                  <div className="absolute top-3.5 left-3.5 bg-gradient-to-r from-sky-600 to-cyan-500 text-white text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-md shadow-md">
                    {project.categoryBadge}
                  </div>

                  {/* Bottom Right Location Badge */}
                  <div className="absolute bottom-3.5 right-3.5 bg-black/75 backdrop-blur-md text-white text-xs font-semibold px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-lg border border-white/10">
                ...
                <div className="p-5 sm:p-8 space-y-5 sm:space-y-6">
                  {/* Scale line */}
                  <div className="text-[11px] font-black uppercase tracking-wider text-sky-600">
                    {project.scale}
                  </div>
                  ...
                  {/* 4 Metrics Box */}
                  <div className="bg-slate-50/80 border border-slate-200/80 rounded-2xl p-3.5 sm:p-5 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 text-center">
                  ...
                  <div className="bg-sky-50/60 border border-sky-100 rounded-2xl p-4 sm:p-5 space-y-1.5">
              ...
              {/* Card Footer Actions */}
              <div className="p-5 sm:p-8 pt-0 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 border-t border-slate-100 mt-2">
                ...
                <Link
                  to="/contact"
                  className="w-full sm:w-auto px-5 py-3 rounded-xl bg-[#06143D] hover:bg-[#09225c] active:bg-[#040e2b] text-white text-xs font-extrabold tracking-wide flex items-center justify-center gap-2 transition duration-200 group cursor-pointer shadow-md"
                >
